	...
	return (
		<div className={`Menu ${classShowmenu}`}>
			...
			<form id='form' className="form" onChange={getCityName} onSubmit={simulateClick}>
				...
				<Link to={`/weather-app/${props.cityName}`} className='link' onClick={props.ChangeMenuActive}>									{/* Esto es parte del "react router". O sea, sirve para cambiar de link. Al hacer click aquí, me redirijo al link selecionado. Recordar que este cambia segun la ciudad tipeada ej: "http://localhost:3000/salto" */}
