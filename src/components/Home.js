	...
	return (
		<div className='Home'>
			<div className='buttons'>
				...
				<Link to="/weather-app/">																										{/* Esto es parte del "react router". O sea, sirve para cambiar de link. Al hacer click aquí, me redirijo al link selecionado. Recordar que este cambia segun la ciudad tipeada ej: "http://localhost:3000/salto" */}
